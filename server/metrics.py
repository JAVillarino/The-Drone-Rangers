...
class RunMetrics:
    ...
    def add_step(self, step: StepMetrics):
        ...
        if len(self.steps) > self.max_steps_in_memory:
            ...
            keep_first = 100
            self.steps = self.steps[:keep_first] + self.steps[-(self.max_steps_in_memory - keep_first):]
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "steps": [s.to_dict() for s in self.steps[-100:]],  # Last 100 steps only in API
...
class MetricsCollector:
    ...
    def __init__(self):
        ...
        self.max_completed_runs = 50  # Keep last 50 completed runs
